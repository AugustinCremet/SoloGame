...
public class MainMenu : MonoBehaviour
{
    ...
    {
        // AC_TODO just to run a test scene
        GameManager.Instance.SetEssentialGameplayObject(true);
        MySceneManager.Instance.LoadNewLevel("ProtoFirstDungeonGF 7", LevelType.Gameplay);
